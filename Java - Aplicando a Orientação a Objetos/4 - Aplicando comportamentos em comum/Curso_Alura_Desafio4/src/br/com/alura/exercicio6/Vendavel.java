...
/*
    ...
    comprada e aplicar descontos. Implemente essa interface nas classes Produto e Servico, cada uma fornecendo a sua
    própria lógica de cálculo de preço.
 */

public interface Vendavel {
    double calcularPrecoFinal(double preco, int qtd);
}
